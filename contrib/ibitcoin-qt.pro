...
RESOURCES += src/qt/ibitcoin.qrc src/qt/ibitcoin_locale.qrc

TRANSLATIONS += src/qt/locale/ibitcoin_bg.ts \
                src/qt/locale/ibitcoin_de.ts \
                src/qt/locale/ibitcoin_en.ts \
                src/qt/locale/ibitcoin_es.ts \
                src/qt/locale/ibitcoin_fi.ts \
                src/qt/locale/ibitcoin_fr.ts \
                src/qt/locale/ibitcoin_it.ts \
                src/qt/locale/ibitcoin_ja.ts \
                src/qt/locale/ibitcoin_pl.ts \
                src/qt/locale/ibitcoin_pt.ts \
                src/qt/locale/ibitcoin_ru.ts \
                src/qt/locale/ibitcoin_sk.ts \
                src/qt/locale/ibitcoin_sv.ts \
                src/qt/locale/ibitcoin_vi.ts \
                src/qt/locale/ibitcoin_zh_CN.ts \
                src/qt/locale/ibitcoin_zh_TW.ts
