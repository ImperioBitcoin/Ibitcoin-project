...
#   c) node1 mines 32 blocks, so now node 0 has 60001ibtc, node 1 has 4250ibtc, node2 has none.
#   d) node0 sends 601 ibtc to node2, in two transactions (301 ibtc, then 300 ibtc).
