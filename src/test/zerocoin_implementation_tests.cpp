...
std::string zerocoinModulus = "25195908475657893494027183240048398571429282126204032028950137836043662020707595556264018525880784"
...
BOOST_AUTO_TEST_CASE(deterministic_tests)
{
    ...
    CziBTCWallet zWallet(wallet.strWalletFile);
    ...
    for (int i = 0; i < nTests; i++) {
        ...
        zWallet.GenerateDeterministicZiBTC(denom, coin, dMint);
