...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ImperioBitcoin Core ibitcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ibitcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ibitcoin transaction") + "\n" +
                               "  ibitcoin-tx [options] -create [commands]   " + _("Create hex-encoded ibitcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ibitcoin transaction
