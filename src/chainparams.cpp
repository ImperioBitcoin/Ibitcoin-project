...
public:
    CMainParams()
    {
        ...
        nP2pPort = 8950;
        nRpcPort = 8951;
        bnProofOfWorkLimit = ~uint256(0) >> 1; //  starting difficulty is 1 / 2^12
        nSubsidyHalvingInterval = 70000;
       ...
       // nEnforceNewSporkKey = 152589510; //!> Sporks signed after (GMT): Tuesday, May 1, 2018 7:00:00 AM GMT must use the new spork key
       //nRejectOldSporkKey = 1527811200; //!> Fully reject old spork key after (GMT): Friday, June 1, 2018 12:00:00 AM
         ...
         */
        const char* pszTimestamp = "iBTC Blockchain Created at 09-07-2021.";
        ...
        genesis.nTime = 1625838947;
        genesis.nBits = 504365040;
        genesis.nNonce = 1774171;

        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("27a02a53322acbcb21ded0970b99304c373fde4c7797d98f2d7372568aac088c"));
        assert(genesis.hashMerkleRoot == uint256("6a5dc6e54cff8f637dd40975dd8491c692f1c6820f0b51133479f6e7833f784d"));

       

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 102); // ImperioBitcoin's wallet address starts with a i
        ...
        strSporkKey = "040e07c813a55914b24c51459ddcc299dc09dde1aa5116df06f82bef801ba515acada3dd3349ebe77ae00e7080a7d6cb34bd674362f49121b6b02bfb4e1ff619d0";
        strObfuscationPoolDummyAddress = "";

        /** Zerocoin */
        zerocoinModulus = "25195908475657893494027183240048398571429282126204032028950137836043662020707595556264018525880784"
        ...
        nZerocoinRequiredStakeDepth = 200; //The required confirmations for a zibtc to be stakable
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // IMPERIOBITCOIN: 1 day
        nTargetSpacing = 1 * 60;  // IMPERIOBITCOIN: 1 minute
        nLastPoWBlock = 200;
        nMaturity = 15;
        ...
        //vSeeds.clear();
       //  vSeeds.push_back(CDNSSeedData("tnseeder-01.ibitcoin.io", "tnseeder-01.ibitcoin.io"));
      //   vSeeds.push_back(CDNSSeedData("testnode-01.ibitcoin.io", "testnode-01.ibitcoin.io"));
        // vSeeds.push_back(CDNSSeedData("testnode-02.ibitcoin.io", "testnode-02.ibitcoin.io"));
       //  vSeeds.push_back(CDNSSeedData("testnode-03.ibitcoin.io", "testnode-03.ibitcoin.io"));
       //  vSeeds.push_back(CDNSSeedData("testnode-04.ibitcoin.io", "testnode-04.ibitcoin.io"));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 17); // Testnet ibitcoin addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 18);  // Testnet ibitcoin script addresses start with '8'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 65);     // Testnet private keys start with 'T'
        // Testnet ibitcoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet ibitcoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet ibitcoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // IMPERIOBITCOIN: 1 day
        nTargetSpacing = 1 * 60;        // IMPERIOBITCOIN: 1 minutes
