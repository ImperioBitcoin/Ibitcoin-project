                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strziBTCPathCustom = GetArg("-zibtcbackuppath", "");
    ...
    if(!strziBTCPathCustom.empty()) {
        ui->wallet_customzibtcbackuppath->setText(QString::fromStdString(strziBTCPathCustom));
        ui->wallet_customzibtcbackuppath_label->setVisible(true);
        ui->wallet_customzibtcbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strziBTCPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ImperioBitcoin RPC console.") + "<br>" +
