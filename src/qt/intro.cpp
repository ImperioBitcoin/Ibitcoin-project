...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ImperioBitcoin Core"),
     ...
     * override -datadir in the ibitcoin.conf file in the default data directory
     * (to be consistent with ibitcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
