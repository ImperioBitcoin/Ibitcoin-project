...
/* ImperioBitcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "iBTCCOIN"
#define QAPP_ORG_DOMAIN "ibtc.io"
#define QAPP_APP_NAME_DEFAULT "iBTCCOIN-Qt"
#define QAPP_APP_NAME_TESTNET "iBTCCOIN-Qt-testnet"
