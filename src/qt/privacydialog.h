...
public:
    ...
    void setZIbtcControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintziBTC_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendziBTC_clicked();
    void on_pushButtonZIbtcControl_clicked();
