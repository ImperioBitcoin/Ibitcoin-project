...
/** Utility functions used by the iBTCCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render iBTCCOIN addresses in monospace font
...
// Parse "ibitcoin:" URI into recipient object, return true on successful parsing
