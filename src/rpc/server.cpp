...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop iBTCCOIN server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "iBTCCOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* iBTCCOIN features */
        {"ibitcoin", "masternode", &masternode, true, true, false},
        {"ibitcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"ibitcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ibitcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ibitcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"ibitcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"ibitcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"ibitcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ibitcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"ibitcoin", "startmasternode", &startmasternode, true, true, false},
        {"ibitcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ibitcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ibitcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ibitcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ibitcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ibitcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ibitcoin", "mnbudget", &mnbudget, true, true, false},
        {"ibitcoin", "preparebudget", &preparebudget, true, true, false},
        {"ibitcoin", "submitbudget", &submitbudget, true, true, false},
        {"ibitcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ibitcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ibitcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ibitcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ibitcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ibitcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ibitcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ibitcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"ibitcoin", "mnsync", &mnsync, true, true, false},
        {"ibitcoin", "spork", &spork, true, true, false},
        {"ibitcoin", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzibtcseed", &getzibtcseed, false, false, true},
        {"zerocoin", "setzibtcseed", &setzibtcseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzibtc", &searchdzibtc, false, false, true},
        {"zerocoin", "dzibtcstate", &dzibtcstate, false, false, true}
...
{
    return "> ibitcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:8951/\n";
}
