...
/**
 * iBTCCOIN RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzibtcseed(const UniValue& params, bool fHelp);
extern UniValue getzibtcseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzibtc(const UniValue& params, bool fHelp);
extern UniValue dzibtcstate(const UniValue& params, bool fHelp);
