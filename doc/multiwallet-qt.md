...
In order to support loading of multiple wallets in ibitcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ibitcoin.cpp.
...
Changes to ibitcoin.cpp
----------------------
ibitcoin.cpp is the entry point into ibitcoin-qt, and as such, will require some minor modifications to provide hooks for
